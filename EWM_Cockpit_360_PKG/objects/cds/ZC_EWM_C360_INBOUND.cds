/*
  View    : ZC_EWM_C360_INBOUND
  Tipo    : Consumption View (ZC_) — List Report + Object Page
  Fonte   : ZI_EWM_C360_HDR (filtrado por PROCESS_TYPE = 'INBOUND')
  Finalidade: Monitoração de documentos de entrada (Inbound Deliveries).
*/
@AbapCatalog.viewEnhancementCategory: [#NONE]
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'C360 - Monitor Inbound'
@Metadata.allowExtensions: true

@UI.headerInfo: {
  typeName:       'Inbound',
  typeNamePlural: 'Inbound',
...
define view entity ZC_EWM_C360_INBOUND
  as select from ZI_EWM_C360_HDR
  where ProcessType = 'INBOUND'
{
  @UI.facet: [
  ...
  @UI.lineItem: [{ position: 30, label: 'Origem' }]
  ...
  /* Associação para drilldown de itens */
  _Items
}
